...
$l['xen_err_mount'] = 'There was an error in mounting the VPS storage';
...
$l['kvm_err_mount'] = 'There was an error in mounting the VPS storage';
...
$l['lxc_err_mount'] = 'There was an error in mounting the VPS storage';
